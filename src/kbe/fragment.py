...
class fragpart:
    def __init__(
        ...
        It defines edge & center for density matching and energy estimation. It also
        forms the base for IAO/PAO partitioning for a large basis set bootstrap
        calculation. Fragments are constructed based on atoms within a unitcell.
        ...
        frag_type : str
            ...
            For systems with only hydrogen, use 'chain'; everything else should
            use 'autogen'
        be_type : str
