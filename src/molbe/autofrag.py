...
def autogen(
    ...
    This value is hardcoded as normdist. Two atoms are defined as bonded if
    they are within 1.8 Angstrom (1.2 for Hydrogen atom).
    ...
    edge_idx : list of list of list of int
        List of edge indices for each fragment where each edge index is a list of LO
        indices.
    ...
    add_centers: list of lists
        "additional centers" for all fragments, per fragment: contains heavy atoms which
        are not centers in any other fragments
