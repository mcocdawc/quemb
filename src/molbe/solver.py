...
def solve_error(Fobjs, Nocc, only_chem=False):
    ...
    This function calculates the error in the one-particle density matrix for
    a given fragment, matching the density matrix elements of the edges and centers.
...
def solve_mp2(mf, frozen=None, mo_coeff=None, mo_occ=None, mo_energy=None):
    ...
    This function sets up and runs an MP2 calculation using the
    provided mean-field object.
...
def solve_uccsd(
    ...
    mean-field object.  It can return the one- and
    two-particle density matrices and the UCCSD object.
...
def schmidt_decomposition(
    ...
    rdm : numpy.ndarray, optional
        Reduced density matrix. If not provided, it will be computed from the
        molecular orbitals. Defaults to None.
    norb : int, optional
